...
import { MyAttendancePage, ShiftsPage, HolidaysPage } from './pages/AttendancePage';
...
import { PayrollPage, PayrollAdjustmentsPage, PayrollConfigPage } from './pages/PayrollPage';
import { ProjectsPage, ProjectExpensesPage, ProjectHealthPage } from './pages/ProjectsPage';
import { ClientsPage } from './pages/ClientsPage';
import { ContractsPage } from './pages/ContractsPage';
import { InvoicesPage, PaymentsPage } from './pages/InvoicesPage';
import { AccountsPage, AuditLogPage, SystemShiftsPage, SystemHolidaysPage, SystemConfigPage } from './pages/SystemPage';
import { HRReportPage, AttendanceReportPage, FinanceReportPage, ProjectReportPage, LeaveReportPage } from './pages/ReportsPage';
